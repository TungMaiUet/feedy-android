...
public class ItemFeedySaveAdapter extends RecyclerView.Adapter<ItemFeedySaveAdapter.ViewHolder> {
    ...
    public ItemFeedySaveAdapter(ArrayList<ItemFeedyList> arrItemFeedyLists, Context context) {
    ...
    @Override
    public ItemFeedySaveAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_feedy_profile, parent, false);
        return new ItemFeedySaveAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ItemFeedySaveAdapter.ViewHolder holder, final int position) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.delete:
                                ...
                                database.deleteDataFeedy(itemFeedyList.getIdFeedy());
